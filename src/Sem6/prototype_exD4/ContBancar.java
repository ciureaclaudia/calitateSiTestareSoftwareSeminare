...
public class ContBancar implements InterfataContCloneable {
    ...
    //construiesc un constructor privat ca s afie apelat DOAR in interiorul clasei
    private ContBancar() {
        this.documente = null;
    }
    @Override
    public InterfataContCloneable cloneaza() {
        ContBancar contCopie = new ContBancar(); //apelez constructorul privat
